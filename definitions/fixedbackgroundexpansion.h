...
namespace TempLat {
    ...
    public:
      ...
      auto operator()( T deltaT) // Scale factor //a(t)
        {
	  return deltaT  ;// pow(1 + H0 / pEoS * deltaT, pEoS);
        }

        auto dot(  T deltaT)  // Scale factor time-derivative //a(t derivative)
        {
	  return  1; //;H0 * pow(1 + H0 / pEoS * deltaT, pEoS- 1);
        }
